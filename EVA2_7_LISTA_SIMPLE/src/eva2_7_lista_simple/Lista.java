...
public class Lista {
    ...
    public void add(Nodo nuevoNodo){
        ...
        if (inicio == null) {  // LISTA VACIA
            ...
            // While|| Consume demasiado, no es eficiente
...
*/
    ...
    public int length(){
        int iCont = 0;  // Variable para contar, iniciada en 0
        Nodo temp = inicio;  // Aqui empezamos
        
        // Mientras no este "temp" en null, nos quedamos en el ciclo:
        while(temp != null){
            iCont++;  // incrementamos el contador
            temp = temp.getSiguiente();  // Mover a temp al siguiente nodo
        }
        return iCont; // Imrpimimos el contador, que sera el tamaño del litsa
    }
    ...
    public void insertarEn(int iPos, Nodo nuevo){
        ...
        // En caso de que sea en cualquier otra posicion
            ...
            Nodo temp = inicio;
            // Movemos temp a la posicion deseada
        ...
        if(length() == 1){
            ...
            // en caso de que sea cualquier otra posicion diferente de 0
                ...
                */
                ...
                if(iPos == length() - 1){ // Verificar si es el ultimo nodo de la lista
                    finnal = temp;
                }
            }
        }
